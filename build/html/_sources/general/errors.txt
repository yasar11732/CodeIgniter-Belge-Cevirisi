...
.. admonition:: Not
    ...
    Log dosyasına yazdırmak için, "log" dizininiz yazılabilir olmalıdır. Ayrıca, kayıt için "eşiği" ayarlamalısınız. Örneğin, sadece hata (error) mesajlarını istiyor ve diğer iki tipi istemiyor olabilirsiniz. Eğer kayıtlama istemiyorsanız sıfır değerini girmelisiniz.
